                    ...
                    <div class="content match-data-wrapper `+winbordercolor+`" id=match-data-wrapper-`+i+` data-match-id="`+i+`">
                      <!--<small>-->
                        ...
                        <div class="columns is-mobile is-0 is-variable is-centered champion-info `+winbordercolor+` `+iswin+`" style="margin-bottom:0 !important; margin-top:0 !important; margin-bottom:0 !important">
                          <div class="column has-vcentered-content is-hidden-desktop is-hidden-table is-hidden-mobile">
                            <div>`+queue_types[matches[i].queue]+`</div>
                            <div>`+m_date.toLocaleDateString()+`</div>
                            <div><strong>`+gameresults[matches[i].win]+`</strong></div>
                            <div>`+duration+` min</div>
                          </div>
                          <div class="column has-vcentered-content c-sum-icons is-narrow is-centered">
                            <div class="c-pic-con">
                        ...
                        <div class="items-wrapper columns is-mobile is-0 is-variable is-centered">
                          <div class="column is-narrow"><img alt="text" alt="text" class="image has-radius-5 has-margin-4 is-32x32" src="`+getItemImage(matches[i].item0)+`"/></div>
                        ...
                        <!-- TABS -->
                          <div class="tabs-view c-table-header `+winbg+` items-wrapper">Shows Tabs</div>
                          <div class="c-table-header summoner-view">
                            <div class="`+winbg+` data-clickable-header"><span class="icon is-small is-left"><i class="fas fa-angle-up"></i></span>&nbsp;Teams</div>
                            <div>
                          ...
                          <div id=matchdata-`+i+` class="match-data no-margin-top">
                    ...
                    function drawSections(data)
                    {
                      ...
                      htmldata = htmldata+`
                        <div class="c-table-header">
                          <div class="data-clickable-header `+winbg+`">
